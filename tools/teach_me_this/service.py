...
def _sanitize(content: str) -> str:
    """Remove control characters that break json.loads but keep newlines between keys."""
    # Strip BOM
    content = content.lstrip("\ufeff")
    # Remove control characters (0x00-0x1f) except we'll handle newlines structurally
    # Replace literal \r\n inside string values (between quotes) with a space
